...
每次执行 `pnpm run test:ui`（或 `pnpm --filter @osmdesign/e2e test:ui`）前，系统会先自动清理旧的：
...
- [latest.md](/Users/mac/osmdesign/osmdesign/e2e/reports/latest.md)
- [ui-test-report.html](/Users/mac/osmdesign/osmdesign/e2e/reports/ui-test-report.html)
