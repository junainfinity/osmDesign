...
Each subfolder is a portable design system in `DESIGN.md` format. Pick one
in the app's design-system picker and every generated project can use it as
part of its visual brief.

## What's bundled

- **`default/`** — Neutral Modern. Hand-authored starter for osmDesign.
...
- **69 product systems**, imported from
  ...
  | Category | Systems |
  |---|---|
  | AI & LLM | cohere · elevenlabs · minimax · mistral-ai · ollama · opencode-ai · replicate · runwayml · together-ai · voltagent · x-ai |
