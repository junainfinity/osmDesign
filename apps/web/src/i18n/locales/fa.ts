...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'osmDesign را راه‌اندازی کنید',
  ...
  'settings.subtitle':
    'بین یک CLI عامل کد محلی و osmAPI (BYOK) انتخاب کنید. کلید API شما فقط در این مرورگر ذخیره می‌شود.',
  ...
  'settings.modelCustomPlaceholder': 'مثلاً gpt-5.2',
  ...
  'newproj.importDesignZip': 'وارد کردن design ZIP',
  'newproj.importDesignZipTitle': 'وارد کردن فایل design .zip',
  'newproj.importingDesignZip': 'در حال وارد کردن…',
  ...
  'avatar.useApi': 'استفاده از osmAPI',
  ...
  'designFiles.dropDesc':
    'تصاویر، اسناد، مراجع، لینک‌های Figma، یا پوشه‌ها — AI از آن‌ها به عنوان زمینه استفاده خواهد کرد.',
