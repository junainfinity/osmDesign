...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройка osmDesign',
  ...
  'settings.subtitle':
    'Выберите между локальным CLI код-агента и osmAPI (BYOK). Ваш API-ключ хранится только в этом браузере.',
  ...
  'settings.modelCustomPlaceholder': 'например, gpt-5.2',
  ...
  'newproj.importDesignZip': 'Импортировать design ZIP',
  'newproj.importDesignZipTitle': 'Импортировать экспортированный design .zip',
  'newproj.importingDesignZip': 'Импорт…',
  ...
  'avatar.useApi': 'Использовать osmAPI',
  ...
  'designFiles.dropDesc':
    'Изображения, документы, ссылки, ссылки Figma или папки — AI будет использовать их как контекст.',
