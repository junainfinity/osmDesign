...
export const zhTW: Dict = {
  ...
  'settings.subtitle':
    '在本機的程式碼代理 CLI 與 osmAPI（自帶 Key）之間切換。API Key 只儲存在當前瀏覽器中。',
  ...
  'newproj.importDesignZip': '匯入 design ZIP',
  'newproj.importDesignZipTitle': '匯入匯出的 design .zip 檔案',
  'newproj.importingDesignZip': '正在匯入…',
  ...
  'designFiles.dropDesc': '圖片、文件、參考資料、Figma 連結或資料夾 — AI 都會用作上下文。',
