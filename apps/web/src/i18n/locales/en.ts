...
export const en: Dict = {
  ...
  'app.brand': 'osmDesign',
  'app.brandPill': 'Desktop',
  'app.brandSubtitle': 'powered by osmAPI',
  'app.welcomeLoading': 'Loading workspace…',

  'settings.welcomeKicker': 'Welcome',
  'settings.welcomeTitle': 'Set up osmDesign',
  'settings.welcomeSubtitle':
    "Pick osmAPI or a local OpenAI-compatible server. You can change this any time from the Settings button in the top bar.",
  'settings.kicker': 'Settings',
  'settings.title': 'Execution & model',
  'settings.subtitle':
    'Use osmAPI.com with your API key, or point osmDesign at a local OpenAI-compatible server.',
  'settings.modeAria': 'Execution mode',
  'settings.modeDaemon': 'AI API',
  'settings.modeDaemonHelp': 'Use osmAPI or a local OpenAI-compatible server',
  'settings.modeDaemonOffline': 'Endpoint unavailable',
  'settings.modeDaemonOfflineMeta': 'offline',
  'settings.modeDaemonInstalledMeta': '{count} presets',
  'settings.modeApi': 'AI API',
  'settings.modeApiMeta': 'osmAPI / local',
  'settings.codeAgent': 'AI endpoint',
  'settings.codeAgentHint':
    'Choose osmAPI or a local OpenAI-compatible server.',
  ...
  'settings.apiHint':
    'API calls are limited to osmAPI.com or a local OpenAI-compatible server. The key is stored locally.',
  'settings.skipForNow': 'Skip for now',
  'settings.getStarted': 'Get started',
  'settings.envConfigure': 'Configure execution mode',
  'settings.localCli': 'AI endpoint',
  'settings.osmApi': 'osmAPI',
  ...
  'settings.modelCustomPlaceholder': 'e.g. gpt-5.2',
  ...
  'newproj.importDesignZip': 'Import design ZIP',
  'newproj.importDesignZipTitle': 'Import an exported design .zip',
  'newproj.importingDesignZip': 'Importing…',
  ...
  'avatar.localCli': 'AI endpoint',
  'avatar.osmApi': 'osmAPI',
  'avatar.useLocal': 'Use AI API',
  'avatar.useApi': 'Use osmAPI',
  'avatar.codeAgent': 'AI endpoint',
  ...
  'designFiles.dropDesc':
    'Images, docs, references, Figma links, or folders — the AI will use them as context.',
  ...
  'agentPicker.localCli': 'AI API',
  'agentPicker.daemonOff': 'offline',
  'agentPicker.byok': 'osmAPI · key',
