...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o osmDesign',
  ...
  'settings.subtitle':
    'Escolha entre uma CLI local de agente de código e a osmAPI (BYOK). Sua chave de API fica salva apenas neste navegador.',
  ...
  'settings.modelCustomPlaceholder': 'ex.: gpt-5.2',
  ...
  'newproj.importDesignZip': 'Importar design ZIP',
  'newproj.importDesignZipTitle': 'Importar um design .zip exportado',
  'newproj.importingDesignZip': 'Importando…',
  ...
  'designFiles.dropDesc':
    'Imagens, docs, referências, links do Figma ou pastas — a IA usará tudo como contexto.',
