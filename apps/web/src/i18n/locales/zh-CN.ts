...
export const zhCN: Dict = {
  ...
  'settings.welcomeTitle': '初始化 osmDesign',
  'settings.welcomeSubtitle':
    '选择你希望使用的执行方式。后续可以随时从顶部「设置」按钮中修改。',
  'settings.kicker': '设置',
  'settings.title': '执行模式与模型',
  'settings.subtitle':
    '在本机的代码代理 CLI 与 osmAPI（自带 Key）之间切换。API Key 只保存在当前浏览器中。',
  ...
  'settings.modelCustomPlaceholder': '例如 gpt-5.2',
  ...
  'newproj.importDesignZip': '导入 design ZIP',
  'newproj.importDesignZipTitle': '导入导出的 design .zip 文件',
  'newproj.importingDesignZip': '正在导入…',
  ...
  'designFiles.dropDesc': '图片、文档、参考资料、Figma 链接或文件夹 — AI 都会用作上下文。',
  ...
  'agentPicker.byok': 'osmAPI · 自带 Key',
