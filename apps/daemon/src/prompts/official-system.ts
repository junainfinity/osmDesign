/**
 * The base system prompt for osmDesign.
 *
 * osmDesign's base "expert designer" prompt. It defines the working identity,
 * workflow, and content philosophy for model runs inside an osmDesign project.
 *
