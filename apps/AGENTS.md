...
pnpm --filter @osmdesign/web test
pnpm --filter @osmdesign/daemon typecheck
pnpm --filter @osmdesign/daemon test
pnpm --filter @osmdesign/daemon build
pnpm --filter @osmdesign/desktop typecheck
pnpm --filter @osmdesign/desktop build
pnpm --filter @osmdesign/packaged typecheck
pnpm --filter @osmdesign/packaged build
```
