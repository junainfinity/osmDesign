...
export const SIDECAR_DEFAULTS = Object.freeze({
  host: "127.0.0.1",
  ipcBase: "/tmp/osmdesign/ipc",
  namespace: "default",
  projectTmpDirName: ".tmp",
  windowsPipePrefix: "osmdesign",
} as const);
...
export type OsmDesignSidecarContract = {
...
export const OSM_DESIGN_SIDECAR_CONTRACT = Object.freeze({
  appKeys: APP_KEYS,
...
} as const satisfies OsmDesignSidecarContract);
